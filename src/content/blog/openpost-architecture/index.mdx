...
The [OpenPost source](https://github.com/getopenpost/openpost) contains the full worker and publication model, and [openpost.social](https://openpost.social) has the project and self-hosting details.
